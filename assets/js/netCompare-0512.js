...
var file_left = "./json/netal-yeastnet.json";
//"./data/subhuman.json"  "./humannet.json" ./json/ex0419/humannet-bak.json  "./json/testjson_human.json"
var file_right = "./json/netal-humannet.json";
