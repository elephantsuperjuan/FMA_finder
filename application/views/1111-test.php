...
<script type="text/javascript" src="<?php echo base_url('assets/d3/sizzle.min.js') ?>"></script> 
...
<script type="text/javascript" src="<?php echo base_url('assets/js/fma-1111.js') ?>"></script>
<!-- <script type="text/javascript" src="<?php echo base_url('assets/js/netCompare-1111.js') ?>"></script>-->
...
window.onscroll = function(){
 ...
 $(document).ready(function () {
    ...
    Zoomable_layout(param_left);

    var param_right = {
        div: document.getElementById("section2"),
        loc: document.getElementById("location2"),
        file: $('#jsonright').attr("value"),
        divid: "section2",
        flag: 'right',
        flag_pre: 'r_',
        contentid: 'content'
    };
    // //file_left = 'http://localhost/netcompare/assets/json/flare.json';

    Zoomable_layout(param_right);
