    ...
    <div class="modal-content">
      ...
      <form id="filterNode_form" >
        <div class="modal-body row">
          <p class="col-md-10 col-md-offset-1 text-muted">option 1:</p>
          <div class="form-group col-md-5 col-md-offset-1">
            <label for="complist1" class="control-label">Node list in Network1:</label>
            <input class="form-control" id="complist1" />
          </div>
          <div class="form-group col-md-5">
            <label for="complist2" class="control-label">Node list in Network2:</label>
            <input class="form-control" id="complist2" />
          </div>

          <p class="col-md-10 col-md-offset-1 text-muted">option 2:</p>
          <div class="form-group col-md-5 col-md-offset-1">
...
<script type="text/javascript" src="<?php echo base_url('assets/js/netCompare-1009.js') ?>"></script>
